...
import { FooterLine, CircleLine } from "../shared/FootballField";
import { LinkText, RotateText } from "@/components/shared/Text";

import { Arrow, Telegram, Whatsapp } from "@/assets/icons/Icons";
import { LogoLetter } from "@/assets/icons/Logo";
  ...
  return (
    ...
    >
      <div className="pt-6 mb-14 px-3.5 md:pt-10 md:px-10 relative z-10">
        <FooterLine className="mb-6 md:mb-10" classLine="bg-white" />
        <div className="flex flex-col md:flex-row md:justify-between">
            ...
            <div className="flex flex-col items-start gap-3">
              <Button variant="link">
                <Link href="/">
                  <RotateText
                    title="Главная"
                    className={isCurrentPage("/") ? "text-primary" : ""}
              ...
              <Button variant="link">
                <Link href="/players">
                  <RotateText
                    title="Игроки"
                    className={isCurrentPage("/players") ? "text-primary" : ""}
                    classLine="bg-primary"
                  />
                </Link>
              </Button>
              <Button variant="link">
                <Link href="/about">
                  <RotateText
                    title="О нас"
                    className={isCurrentPage("/about") ? "text-primary" : ""}
                    classLine="bg-primary"
                  />
                </Link>
              </Button>
            ...
            <div className="flex flex-col items-end gap-3">
              <Button variant="link">
                <Link href="/news">
                  <RotateText
                    title="Новости"
                    className={isCurrentPage("/news") ? "text-primary" : ""}
                    classLine="bg-primary"
                  />
                </Link>
              </Button>
              <Button variant="link">
                <Link href="/team">
                  <RotateText
                    title="Команда"
                    className={isCurrentPage("/team") ? "text-primary" : ""}
                    classLine="bg-primary"
                  />
                </Link>
              </Button>
          ...
          <div className="flex flex-row justify-between mb-6 md:mb-0 md:gap-28">
            ...
            <div className="flex flex-col-reverse items-start gap-8">
              <div className="flex flex-col items-end font-unbounded font-bold text-base uppercase md:items-start md:gap-3">
                <Link href="mailto:info@f-a-f.ru">
                  <LinkText title="info@f-a-f.ru" classLine="bg-white" />
                </Link>
                <Link href="tel:+79651864101">
                  <LinkText title="+7(965)186-41-01" classLine="bg-white" />
                </Link>
              </div>
              {!isMobile && (
                <Link href="/form">
          ...
          {isMobile && (
            <Button className="w-fit px-11 py-4">
              <Link
                href="/form"
      ...
      <div ref={sectionRef} className="relative z-0">
        <div className="md:absolute max-h-64 w-full top-0 left-0 md:-translate-y-1/3">
          <CircleLine
            className="h-16 md:h-[calc(100vw*0.8)]"
            classNameCircle="w-[calc(100vw*1.9)] md:w-[calc(100vw*0.8)]"
          />
        </div>
        <div ref={logoRef}>
          <LogoLetter className="mx-14 md:max-h-64 md:mx-auto" />
        </div>
      </div>
      <div className="bg-foreground relative z-10 border-t md:border-x border-inherit flex flex-col md:flex-row items-center gap-5 text-xs uppercase text-[#91918A] py-6 mt-3 md:mt-5 md:justify-between md:px-10 md:mx-10">
        ...
        <Link href="https://t.me/a_dari">
          <LinkText title="Дизайн сайта" classLine="bg-[#91918A]" />
        </Link>
